    ...
    return (
        <div id='tasklist' className='h-[55%] overflow-x-auto flex items-center justify-start gap-5 flex-nowrap w-full py-5 mt-10'>
            ...
            <div className='shrink-0 h-full w-[300px] p-5 bg-yellow-400  rounded-xl'>
                ...
                <p className='text-sm mt-2'> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quam, tenetur eum? Nam libero eveniet beatae.</p>
            </div>
            ...
            <div className='shrink-0 h-full w-[300px] p-5 bg-orange-400  rounded-xl'>
